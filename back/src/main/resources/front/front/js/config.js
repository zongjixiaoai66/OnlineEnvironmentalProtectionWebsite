...
var centerMenu = [
    ...
    ,{
        name: '濒危生物收藏',
        url: '../binweishengwuCollection/list.html'
    }
    ,{
        name: '环保健康收藏',
        url: '../huanbaojiankangCollection/list.html'
    }
    ,{
        name: '环境保护收藏',
        url: '../huanjingbaohuCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '濒危生物',
        url: './pages/binweishengwu/list.html'
    },
    {
        name: '论坛',
    ...
    {
        name: '环保健康',
        url: './pages/huanbaojiankang/list.html'
    },
    {
        name: '环境保护',
        url: './pages/huanjingbaohu/list.html'
    },
    {
        name: '环境保护法',
        url: './pages/huanjingbaohufa/list.html'
    },
    {
        name: '公告信息',
...
var adminurl =  "http://localhost:8080/huanbaowangzhan/admin/dist/index.html#/login";

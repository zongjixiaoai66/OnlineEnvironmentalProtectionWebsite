...
public class HuanbaojiankangController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        //字典表数据转换
        List<HuanbaojiankangView> list =(List<HuanbaojiankangView>)page.getList();
        for(HuanbaojiankangView c:list){
            //修改对应字典表字段
    ...
    */
    ...
    public R save(@RequestBody HuanbaojiankangEntity huanbaojiankang, HttpServletRequest request){
        ...
        Wrapper<HuanbaojiankangEntity> queryWrapper = new EntityWrapper<HuanbaojiankangEntity>()
...
//            return R.error(511,"永远不会进入");
        //根据字段查询是否有相同数据
        Wrapper<HuanbaojiankangEntity> queryWrapper = new EntityWrapper<HuanbaojiankangEntity>()
            .notIn("id",huanbaojiankang.getId())
            .andNew()
            .eq("huanbaojiankang_name", huanbaojiankang.getHuanbaojiankangName())
            .eq("huanbaojiankang_types", huanbaojiankang.getHuanbaojiankangTypes())
            .eq("zan_number", huanbaojiankang.getZanNumber())
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<HuanbaojiankangEntity> huanbaojiankangList = new ArrayList<>();//上传的东西
...
//                            huanbaojiankangEntity.setHuanbaojiankangName(data.get(0));                    //标题 要改的
//                            huanbaojiankangEntity.setHuanbaojiankangTypes(Integer.valueOf(data.get(0)));   //环保健康类型 要改的
//                            huanbaojiankangEntity.setHuanbaojiankangPhoto("");//详情和图片
//                            huanbaojiankangEntity.setZanNumber(Integer.valueOf(data.get(0)));   //赞 要改的
//                            huanbaojiankangEntity.setCaiNumber(Integer.valueOf(data.get(0)));   //踩 要改的
//                            huanbaojiankangEntity.setHuanbaojiankangContent("");//详情和图片
//                            huanbaojiankangEntity.setInsertTime(date);//时间
//                            huanbaojiankangEntity.setCreateTime(date);//时间

...
public class BinweishengwuCollectionView extends BinweishengwuCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String binweishengwuCollectionValue;
	...
	public BinweishengwuCollectionView() {

	}

	public BinweishengwuCollectionView(BinweishengwuCollectionEntity binweishengwuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, binweishengwuCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getBinweishengwuCollectionValue() {
				return binweishengwuCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setBinweishengwuCollectionValue(String binweishengwuCollectionValue) {
				this.binweishengwuCollectionValue = binweishengwuCollectionValue;
			}

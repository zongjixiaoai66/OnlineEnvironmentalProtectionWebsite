...
public class HuanbaojiankangLiuyanView extends HuanbaojiankangLiuyanEntity implements Serializable {
	...
	public HuanbaojiankangLiuyanView() {

	}

	public HuanbaojiankangLiuyanView(HuanbaojiankangLiuyanEntity huanbaojiankangLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, huanbaojiankangLiuyanEntity);

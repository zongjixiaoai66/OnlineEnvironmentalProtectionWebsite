...
public class HuanjingbaohuLiuyanView extends HuanjingbaohuLiuyanEntity implements Serializable {
	...
	public HuanjingbaohuLiuyanView() {

	}

	public HuanjingbaohuLiuyanView(HuanjingbaohuLiuyanEntity huanjingbaohuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, huanjingbaohuLiuyanEntity);
